        ...
        <div className="flex items-center justify-between h-12">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button
              ...
              className="text-xs bg-primary text-white px-4 py-1.5 rounded-full font-semibold hover:bg-primary/90 transition-colors flex items-center gap-1.5"
            >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="md:hidden bg-card-bg/95 backdrop-blur-xl border-t border-border-light">
          <div className="px-6 py-4 space-y-3">
            ...
            <button
              ...
              className="w-full bg-primary text-white font-semibold px-5 py-2.5 rounded-full text-center text-sm mt-3 flex items-center justify-center gap-1.5 hover:bg-primary/90 transition-colors"
            >
